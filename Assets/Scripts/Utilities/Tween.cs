...
public class Tween : MonoBehaviour {
    ...
    public void MoveTo(Transform obj, Vector3 posTo, float time, Easing.Ease easing)
    {
    ...
    public void MoveArcToLocal(Transform obj, Vector3 posTo, float arcHeight, float time, Easing.Ease easing)
    {
        Task task = AddTask(time, easing);
    ...
    public void RotateTo(Transform obj, Quaternion rotTo, float time, Easing.Ease easing)
    {
        Task task = AddTask(time, easing);
